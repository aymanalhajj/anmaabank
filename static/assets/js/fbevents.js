                    ...
                    k.exports = function(a) {
                        ...
                        function r(a, b) {
                            ...
                            if (null == b)
                                return !1;
                            var c = a.value;
                            return null != c && (a.extractor !== j.TOKENIZED_TEXT_V1 && a.extractor !== j.TOKENIZED_TEXT_V2 || (c = c.toLowerCase()),
                                function(a, b, c) {
                                    switch (a) {
                                        case i.EQUALS:
                        ...
                        a.exports = {
                            isMatchESTRule: function(a, b) {
                                ...
                                for (var a = d(c, e), c = [], f = 0; f < a.conditions.length; f++)
                                    c.push(r(a.conditions[f], b));
                                switch (a.type) {
                                    case k.ALL:
                                        return !c.includes(!1);
                                    case k.ANY:
                        ...
                        function m(a) {
                            ...
                            return (m = function(a) {
                                if (null === a || (c = a, -1 === Function.toString.call(c).indexOf("[native code]")))
                                    return a;
                                var c;
                                if ("function" != typeof a)
                        ...
                        function v(a, b) {
                            try {
                                ...
                                if ("FBEventsCoercionError" === a.name)
                                    return null;
                                throw a
                            }
                        }
                            ...
                            A = {
                                ...
                                fbid: function() {
                                    return y({
                                        def: function(a) {
                                            var b = v(a, A.number());
                                            return null != b ? (A.assert(s(b)),
                                                "".concat(b)) : w(a, A.string())
                                        },
                                        validators: [function(a) {
                                            return z.test(a)
                                        }]
                                ...
                                object: function() {
                                    return function(a) {
                                        if ("object" !== g(a) || Array.isArray(a) || null == a)
                                            throw new t();
                                        return a
                                    }
                                },
                                objectOrString: function() {
                                    return function(a) {
                                        if ("object" !== g(a) && "string" != typeof a || Array.isArray(a) || null == a)
                                            throw new t();
                                        return a
                                    }
                                },
                        ...
                        function s(a) {
                            if ("object" !== f(a) && ("function" != typeof a || null === a))
                                throw new TypeError("Object.keys called on non-object");
                            var b = [];
                            for (var c in a)
                                o.call(a, c) && b.push(c);
                        ...
                        c = {
                            FBSet: function() {
                                function a(b) {
                                    ...
                                    c = this,
                                        f = void 0,
                                        (d = e("items")) in c ? Object.defineProperty(c, d, {
                                            value: f,
                                            enumerable: !0,
                                            configurable: !0,
                                            writable: !0
                        ...
                        var A = function() {
                                function a(b) {
                                    ...
                                    y(this, "_anchorElement", void 0),
                                        y(this, "_parsedQuery", void 0),
                        ...
                        j = function a(b, c) {
                            if (">" === c[c.length - 1])
                                return [];
                            var d = ">" === c[0];
                            if ((a.CAN_USE_SCOPE || !c.match(B)) && !d)
                                ...
                                if (null != c) {
                                    ...
                                    try {
                                        if (a = (c = c.call(a)).next,
                                            ...
                                            for (; !(h = (d = a.call(c)).done) && (f.push(d.value),
                                                    f.length !== b); h = !0)
                                        ;
                                    } catch (a) {
                                        g = !0,
                        ...
                        function ia(a, b) {
                            if (a) {
                                ...
                                var c = Object.prototype.toString.call(a).slice(8, -1);
                                return "Object" === c && a.constructor && (c = a.constructor.name),
                                    "Map" === c || "Set" === c ? Array.from(a) : "Arguments" === c || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(c) ? Q(a, b) : void 0
                            }
                        }
                        ...
                        function la(a, b, c, d) {
                            var e = T(a, d.node);
                            return e === R ? e : c > 0 && b !== d.index ? R : 1 === e ? S : 0 === d.relativeClass.length ? R : (ja(a, d.node),
                                d.relativeClass,
                                S)
                        }
                        ...
                        function oa(a, b) {
                            ...
                            b = function(a, b, c) {
                                for (var d = [], a = a.firstChild; a;)
                                    a.isSameNode(b.node) || a.isSameNode(c) || !T(b.node, a) || d.push(a),
                                    a = a.nextSibling;
                                return d
