...
const sliderservicesmobile = () => {
  ...
  var servicesdetailssection = document.getElementsByClassName("slider-services-details-js");
  ...
  if (
    ...
    Array.prototype.forEach.call(servicesdetailssection, function (element) {
      // servicessection.forEach((navbarlink) => {
      // if (!element.hash) return;
      // let section = select(navbarlink.hash);
      // if (!section) return;
      element.classList.add("services-details-slider-mopile");
      element.classList.remove("services-details-slider");
    ...
    Array.prototype.forEach.call(servicesdetailssection, function (element) {
      ...
      // let section = select(navbarlink.hash);
      // if (!section) return;
      element.classList.add("services-details-slider");
      element.classList.remove("services-details-slider-mopile");
      // if (element.classList.contains("slider-services") == true) {
...
new Swiper(".services-details-slider-mopile", {
  speed: 600,
  autoplay: {
    delay: 5000,
    disableOnInteraction: false,
...
new Swiper(".coins-slider", {
  ...
  // },
  // navigation: {
  //   nextEl: '.coins-city-slider-next',
  //   prevEl: '.coins-city-slider-prev ',
  // },
  // breakpoints: {
  //   320: {
  //     slidesPerView: 2,
