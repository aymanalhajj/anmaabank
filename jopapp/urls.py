...
urlpatterns = [
    ...
    path("admin/<int:id>", customadmin.as_view(),
         name='home-jop-manage-admin-detil'),
    ...
    path("education/deleteeducation/<int:id>",
         DeleteEducation, name='deleteeducation'),

    path("languagskills/DeleteLangskils/<int:id>",
         DeleteLangskils, name='DeleteLangskils'),
    path("computerskills/DeleteComSilks/<int:id>",
         DeleteComSilks, name='DeleteComSilks'),
    path("triningcourses/DeleteTraincoiurses/<int:id>",
         DeleteTraincoiurses, name='DeleteTraincoiurses'),
    path("experincev/DeleteExperiene/<int:id>",
         DeleteExperiene, name='DeleteExperiene'),
    path("employment/DeleteEmployment/<int:id>",
         DeleteEmployment, name='DeleteEmployment'),
    path("BankKonown/Deletebanknow/<int:id>",
         Deletebanknow, name='Deletebanknow'),
    path("education/UpdateEducation/<int:id>",
         UpdateEducation, name='UpdateEducation'),
    path("languagskills/UpdateLangskils/<int:id>",
         UpdateLangskils, name='UpdateLangskils'),
    path("computerskills/UpdateComputerSkil/<int:id>",
         UpdateComputerSkil, name='UpdateComputerSkil'),
    path("triningcourses/UpdateTrainingCourses/<int:id>",
         UpdateTrainingCourses, name='UpdateTrainingCourses'),
    path("experince/UpdateExperience/<int:id>",
         UpdateExperience, name='UpdateExperience'),
    path("employment/UpdateEmployment/<int:id>",
         UpdateEmployment, name='UpdateEmployment'),
    path("BankKonown/UpdateBankKonown/<int:id>",
         UpdateBankKonown, name='UpdateBankKonown'),
