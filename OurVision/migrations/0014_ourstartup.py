# Generated by Django 3.2.22 on 2023-12-16 13:03
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('OurVision', '0013_auto_20231216_1601'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detial_ar', models.TextField(blank=True, default=' ', null=True, verbose_name='تفاصيل رؤية الشركة')),
                ('titel_en', models.CharField(max_length=250, null=True, verbose_name='عنوان القسم بالانجليزي')),
                ('detial_en', models.TextField(blank=True, default=' ', null=True, verbose_name='تفاصيل رؤية الشركة بالانجليزي')),
                ...
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='OurStartup_created_by', to=settings.AUTH_USER_MODEL, verbose_name='تم الأنشاء بواسطة ')),
                ('deleted_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='OurStartup_deleted_by', to=settings.AUTH_USER_MODEL, verbose_name=' تم الحذف  بواسطة ')),
                ('edited_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='OurStartup_edited_by', to=settings.AUTH_USER_MODEL, verbose_name=' تم التعديل  بواسطة ')),
            ],
            options={
