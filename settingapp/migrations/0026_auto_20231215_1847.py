...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('settingapp', '0025_auto_20231204_1557'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            name='footer_en',
            field=models.CharField(default=' جميع الحقوق محفوظة © لـ بنك الإنماء للتمويل الأصغر الإسلامي 2023', max_length=300, null=True, verbose_name='الحقوق انجليزي'),
        ),
        ...
        migrations.AlterField(
            model_name='settingmodel',
            name='footer',
            field=models.CharField(default=' جميع الحقوق محفوظة © لـ بنك الإنماء للتمويل الأصغر الإسلامي 2023', max_length=300, null=True, verbose_name='الحقوق عربي'),
        ),
        migrations.AlterField(
            model_name='settingmodel',
            name='instagram',
