...
urlpatterns += [
    ...
    re_path(r"^(?P<lang>\bar\b|\ben\b)/register$", ProfileRegistration.as_view(), name='createaccoute-user'),
    ...
    # re_path(r"^(?P<lang>\bar\b|\ben\b)/jobs/education/$", educationView.as_view(), name='education'),
    re_path(r"^(?P<lang>\bar\b|\ben\b)/jobs/education/deleteeducation/(?P<id>.*)$",         DeleteEducation, name='deleteeducation'),
    re_path(r"^(?P<lang>\bar\b|\ben\b)/jobs/languagskills/DeleteLangskils/(?P<id>.*)$",         DeleteLangskils, name='DeleteLangskils'),
    re_path(r"^(?P<lang>\bar\b|\ben\b)/jobs/computerskills/DeleteComSilks/(?P<id>.*)$",         DeleteComSilks, name='DeleteComSilks'),
    re_path(r"^(?P<lang>\bar\b|\ben\b)/jobs/triningcourses/DeleteTraincoiurses/(?P<id>.*)$",         DeleteTraincoiurses, name='DeleteTraincoiurses'),
    re_path(r"^(?P<lang>\bar\b|\ben\b)/jobs/experincev/DeleteExperiene/(?P<id>.*)$",         DeleteExperiene, name='DeleteExperiene'),
    re_path(r"^(?P<lang>\bar\b|\ben\b)/jobs/employment/DeleteEmployment/(?P<id>.*)$",         DeleteEmployment, name='DeleteEmployment'),
    re_path(r"^(?P<lang>\bar\b|\ben\b)/jobs/BankKonown/Deletebanknow/(?P<id>.*)$",         Deletebanknow, name='Deletebanknow'),
    re_path(r"^(?P<lang>\bar\b|\ben\b)/jobs/education/UpdateEducation/(?P<id>.*)$",         UpdateEducation, name='UpdateEducation'),
    re_path(r"^(?P<lang>\bar\b|\ben\b)/jobs/languagskills/UpdateLangskils/(?P<id>.*)$",         UpdateLangskils, name='UpdateLangskils'),
    re_path(r"^(?P<lang>\bar\b|\ben\b)/jobs/computerskills/UpdateComputerSkil/(?P<id>.*)$",         UpdateComputerSkil, name='UpdateComputerSkil'),
    re_path(r"^(?P<lang>\bar\b|\ben\b)/jobs/triningcourses/UpdateTrainingCourses/(?P<id>.*)$",         UpdateTrainingCourses, name='UpdateTrainingCourses'),
    re_path(r"^(?P<lang>\bar\b|\ben\b)/jobs/experince/UpdateExperience/(?P<id>.*)$",         UpdateExperience, name='UpdateExperience'),
    re_path(r"^(?P<lang>\bar\b|\ben\b)/jobs/employment/UpdateEmployment/(?P<id>.*)$",         UpdateEmployment, name='UpdateEmployment'),
    re_path(r"^(?P<lang>\bar\b|\ben\b)/jobs/BankKonown/UpdateBankKonown/(?P<id>.*)$",         UpdateBankKonown, name='UpdateBankKonown'),
    re_path(r"^(?P<lang>\bar\b|\ben\b)/jobs/OrderJob/(?P<id>.*)$", OrderJobView.as_view(), name='OrderJob'),
    ...
    re_path(r"^(?P<lang>\bar\b|\ben\b)/jobs/detail/(?P<id>.*)$", detail, name='job-singles'),
